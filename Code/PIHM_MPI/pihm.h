...
int ***EleNabrSequence, **EleSeqCounter,***RivNabrSequence, **RivSeqCounter,***RivEleNabrSequence, **RivEleSeqCounter,***EleRivNabrSequence, **EleRivSeqCounter,*NumEleInProc,*NumRivInProc,my_pe,MaxInProc,TSize,RivOut,**RivInProc,*RivInProcCounter,**EleInProc,*EleInProcCounter ;
MPI_Comm comm;

...
/*		if(DS->TSD_Prep[i].TS[j][0]<=90.0)
		{	
			DS->TSD_Prep[i].TS[j][1]=0.426*0.4*DS->TSD_Prep[i].TS[j][1];
		}
		if(DS->TSD_Prep[i].TS[j][0]>90.0 && DS->TSD_Prep[i].TS[j][0]<=150.0)
		{
			DS->TSD_Prep[i].TS[j][1]=-0.2*0.65*DS->TSD_Prep[i].TS[j][1];
		}
		if(DS->TSD_Prep[i].TS[j][0]>150.0 && DS->TSD_Prep[i].TS[j][0]<=210)
                 {
                         DS->TSD_Prep[i].TS[j][1]=-0.3*0.45*DS->TSD_Prep[i].TS[j][1];
                 }
		if(DS->TSD_Prep[i].TS[j][0]>210.0 && DS->TSD_Prep[i].TS[j][0]<=242)
                 {
                         DS->TSD_Prep[i].TS[j][1]=0.337*0.10*DS->TSD_Prep[i].TS[j][1];
                 }
		if(DS->TSD_Prep[i].TS[j][0]>242 && DS->TSD_Prep[i].TS[j][0]<=258)
		{	
			DS->TSD_Prep[i].TS[j][1]=-0.939*0.01*DS->TSD_Prep[i].TS[j][1];           
		}
		if(DS->TSD_Prep[i].TS[j][0]>258 && DS->TSD_Prep[i].TS[j][0]<=334)
                {
                        DS->TSD_Prep[i].TS[j][1]=0.683*0.22*DS->TSD_Prep[i].TS[j][1];         
                }	
		 if(DS->TSD_Prep[i].TS[j][0]>334 && DS->TSD_Prep[i].TS[j][0]<=365)
                {
                        DS->TSD_Prep[i].TS[j][1]=0.683*0.3*DS->TSD_Prep[i].TS[j][1];
                }
*/ 

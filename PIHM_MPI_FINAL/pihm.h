...
/* Defining some global arrays for MPI */
int ***EleNabrSequence, **EleSeqCounter,***RivNabrSequence, **RivSeqCounter,***RivEleNabrSequence, **RivEleSeqCounter,***EleRivNabrSequence, **EleRivSeqCounter,***EleRivNabrSequence_RivIndex, **EleRivSeqCounter_RivIndex,*NumEleInProc,*NumRivInProc,my_pe,MaxInProc,TSize,RivOut,**RivInProc,*RivInProcCounter,**EleInProc,*EleInProcCounter ;
MPI_Comm comm;
...
typedef struct element_type	/* Data model for a triangular element */ 
	{
  	int procNo;         	/* processor or partition number of element */				//xchen_20150404
...
typedef struct river_segment_type
	...
	realtype coeff;		/* Coefficient c in D = c*pow(B/2,interpOrd) where D is depth*/ 
  	...
  	int up[7];			/* up stream segment */						//xchen_20150404
	int proc;            	/* processor or partition number of river segment */			//xchen_20150404
	int NumDRiv;		/*Num of down stream segment. Right Now NumDRiv=1. MaxmPossibleValue=7 */	//xchen_20150404
	int NumURiv;		/* Num of up stream segment. MaxmPossibleValue=7 */			//xchen_20150404
...
typedef struct model_data_structure 	/* Model_data definition */
	{
 	...
 	int NumProc;                 	/* Number of Processors or Partitions */
//	MPI_Comm comm;			//xchen_20150410	
//	int npes, my_pe;		//xchen_20150410
...
typedef struct control_data_structure
	...
	int q_out;	/* Output streamflow data	xchen_20150405*/
